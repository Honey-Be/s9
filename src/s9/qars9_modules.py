"""QARS9: Quantized ARS9 Layer (real I/O, conjugate-pair complex internal)."""
...
class QARS9Layer(nn.Module):
    """Quantized ARS9 Layer — wraps ARS9Layer with per-component quantization."""
