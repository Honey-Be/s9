...
def test_riesz_sst(D: int, dtype_idx: FPDTypeIdx):
    ...
    sst = SynchronizedGenericSST[RieszTransform, InverseRieszTransform](riesz, dtype_idx)
    isst = sst.get_inverse_transform()
    cache_key=f"Riesz{D}D_sst_{dtype_idx}"
