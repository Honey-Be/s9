...
from s9.examples import MultiheadARS9ClassifierModelExample
...
def test_mock_multihead_ars9_classification(D: int, dtype_idx: FPDTypeIdx, H: int):
    ...
    model = MultiheadARS9ClassifierModelExample(
